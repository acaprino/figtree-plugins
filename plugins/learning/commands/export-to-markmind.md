...
2. **Render to MarkMind** (skill: `learning:markmind-exporter`): pipe the JSON outline to `plugins/learning/skills/markmind-exporter/scripts/generate_markmind.py` with `--output` flag to produce the `.md` file.
